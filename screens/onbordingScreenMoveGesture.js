...
export const OnbordingMoveGesture  = ({ navigation, route }) => {
    return (
        <SafeAreaView style={{flex: 1, flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', backgroundColor: '#101010'}}>
            <NavbarContainer>
                <ButtonBack onPress={() => navigation.goBack()} />
                <Numerator title='12' title_sec='17'/>
            </NavbarContainer>
            <RoomName>Комната №1</RoomName>
            <Field>
            <TextField>
                <Text style={{fontSize: 15, lineHeight: 25, color: 'white'}}>И последнее — зажмите два пальца  подвигайте ими по экрану</Text>
            </TextField>
            <GestureField>
                <Image source={require('../assets/moveGestureAnimation.png')} style={{width: 286, height: 326}}/>
            </GestureField>
            </Field>
            <ButtonPrimary onPress={() => navigation.navigate('Onbording_15')} title='Дальше' />
        </SafeAreaView> 
    );
  }
